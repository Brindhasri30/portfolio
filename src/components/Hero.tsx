...
const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (typing) {
      if (text.length < curr.length) {
        t = setTimeout(() => setText(curr.slice(0, text.length + 1)), 75);
      } else {
  ...
  return (
    <section id="home" className="hero">
      ...
      <div className="hero-blob blob4" />
      <div className="blob-ring ring1" />
      <div className="blob-ring ring2" />
      ...
      <div className="hero-split">
        ...
        <div className="hero-left">
          ...
          <p className="hero-bio">{portfolioData.about}</p>

          {/* Social icons — circles only, no text labels */}
          <div className="hero-socials">
            <a href={portfolioData.leetcode} target="_blank" rel="noopener noreferrer" className="social-icon" title="LeetCode">
              <IconLeetCode />
            </a>
